...
from testr.authentication_executor.authenticators.authenticator_factory import AuthenticatorFactory
from testr.authentication_executor.authenticators.base_authenticator import AuthenticationResult
